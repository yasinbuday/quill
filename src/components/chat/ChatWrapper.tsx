  ...
  if (isLoading)
    return (
      <div className="relative min-h-full bg-zinc-50 flex flex-col justify-between gap-2">
        <div className="flex-1 flex justify-center items-center flex-col mb-28 pb-6">
  ...
  if (data?.status === "FAILED")
    ...
    return (
        <ChatContextProvider fileId={fileId}>
          <div className='relative min-h-full bg-zinc-50 flex flex-col justify-between gap-2 mb-6'>
            <div className='flex-1 justify-between flex flex-col mb-28 pb-6'>
